...
class _FlutterFlowDropDownState<T> extends State<FlutterFlowDropDown<T>> {
  ...
  Widget build(BuildContext context) {
    final value = widget.options.contains(widget.controller.value)
        ...
        : null;
    final List<DropdownMenuItem<T>> items = widget.options
        .asMap()
        .entries
        .map(
          (MapEntry<int, T> option) => DropdownMenuItem<T>(
            value: option.value,
            child: Text(
  ...
  Widget _buildSearchableDropdown(
    ...
    final WidgetStateProperty<Color?> overlayColor = WidgetStateProperty.resolveWith<Color?>((Set<WidgetState> states) =>
        states.contains(WidgetState.focused) ? Colors.transparent : null);
    final IconStyleData iconStyleData = widget.icon != null
