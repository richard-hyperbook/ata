...
class FFLocalizations {
  ...
  static List<String> languages() => <String>['en'];
...
final Map<String, Map<String, String>> kTranslationsMap =
    <Map<String, Map<String, String>>>[].reduce((Map<String, Map<String, String>> a, Map<String, Map<String, String>> b) => a..addAll(b));
