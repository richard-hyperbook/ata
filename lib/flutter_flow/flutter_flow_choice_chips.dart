...
class _FlutterFlowChoiceChipsState extends State<FlutterFlowChoiceChips> {
  ...
  List<String> get selectedValues => widget.controller.value ?? <String>[];
  ...
  Widget build(BuildContext context) => Wrap(
        ...
        children: <Widget>[
          ...widget.options.map(
            (ChipData option) {
              final bool selected = choiceChipValues.contains(option.label);
              final ChipStyle style = selected
                    ...
                    ? (bool isSelected) {
                        if (isSelected) {
                          widget.multiselect
                              ...
                              : choiceChipValues = <String>[option.label];
